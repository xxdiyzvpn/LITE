...
startlotserver() {
  ...
  #echo | bash <(wget --no-check-certificate -qO- https://raw.githubusercontent.com/xxdiyzvpn/LITE//main/lotServerInstall.sh) install
  echo | bash <(wget --no-check-certificate -qO- https://raw.githubusercontent.com/xxdiyzvpn/LITE//main/lotServerInstall.sh) install
...
remove_bbr_lotserver() {
  ...
  if [[ -e /appex/bin/lotServer.sh ]]; then
    echo | bash <(wget -qO- https://raw.githubusercontent.com/xxdiyzvpn/LITE//main/lotServerInstall.sh) uninstall
  fi
  clear
...
remove_all() {
  ...
  if [[ -e /appex/bin/lotServer.sh ]]; then
    bash <(wget -qO- https://raw.githubusercontent.com/xxdiyzvpn/LITE//main/lotServerInstall.sh) uninstall
  fi
  clear
